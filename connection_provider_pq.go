...
func (c *StandardDatabaseConnection) ExecContext(ctx context.Context, query string, args ...any) (any, error) {
	return c.DB.ExecContext(ctx, query, args...)
}

// QueryRowContext implements DatabaseConnection.QueryRowContext.
func (c *StandardDatabaseConnection) QueryRowContext(ctx context.Context, query string, args ...any) Row {
